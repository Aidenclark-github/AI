...
* Notebook: [Logistic regression](https://nbviewer.jupyter.org/github/badriadhikari/AI/blob/main/notebooks/Logistic_regression.ipynb)
...
* Notebook: [Binary classification](https://nbviewer.jupyter.org/github/badriadhikari/AI/blob/main/notebooks/Binary_classification.ipynb)
...
* Notebook: [Univariate Linear Regression](https://nbviewer.jupyter.org/github/badriadhikari/AI/blob/main/notebooks/Univariate_linear_regression.ipynb)
